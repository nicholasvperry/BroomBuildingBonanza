...
const BroomImageSettings = ({ ...props }) => {
    const group = useRef()
    const { nodes, materials } = useGLTF('/pictures/ebonyBroomSticks/ebonyStar.glb')
    useFrame(() => {
...
useGLTF.preload('/pictures/ebonyBroomSticks/ebonyStar.glb')