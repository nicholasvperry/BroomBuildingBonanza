...
const BroomImageSettings = ({ ...props }) => {
    const group = useRef()
    const { nodes, materials } = useGLTF('/pictures/ebonyBroomSticks/ebonyFire.glb')
    //Rotate the image
    useFrame(() => {
...
useGLTF.preload('/pictures/ebonyBroomSticks/ebonyFire.glb')