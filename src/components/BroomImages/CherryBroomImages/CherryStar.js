...
const BroomImageSettings = ({ ...props }) => {
    const group = useRef()
    const { nodes, materials } = useGLTF('/pictures/cherryBroomSticks/cherryStar.glb')
    useFrame(() => {
...
useGLTF.preload('/pictures/cherryBroomSticks/cherryStar.glb')