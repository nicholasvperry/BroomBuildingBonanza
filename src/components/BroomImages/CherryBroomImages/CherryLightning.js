...
const BroomImageSettings = ({ ...props }) => {
    const group = useRef()
    const { nodes, materials } = useGLTF('/pictures/cherryBroomSticks/cherryLightning.glb')
    useFrame(() => {
...
export const CherryLightningBroom = () => {
  return (
    <Canvas>
      <OrbitControls />
...
useGLTF.preload('/pictures/cherryBroomSticks/cherryLightning.glb')